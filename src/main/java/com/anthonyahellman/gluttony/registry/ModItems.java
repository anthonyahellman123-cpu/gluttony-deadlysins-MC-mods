...
import com.anthonyahellman.gluttony.item.CoinOfMammonItem;
...
public final class ModItems {
    ...
    public static final RegistryObject<Item> COIN_OF_MAMMON = ITEMS.register("coin_of_mammon", CoinOfMammonItem::new);
    private ModItems() {}
}
